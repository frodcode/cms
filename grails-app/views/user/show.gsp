...
<%@ page import="skolka_utulna.acl.User" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${userInstance?.id}" params="[websiteSlug: websiteSlug]"><g:message code="default.button.edit.label" default="Edit" /></g:link>
