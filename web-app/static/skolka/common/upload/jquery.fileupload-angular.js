        ...
        .controller('FileUploadController', [
            ...
            function ($scope, $element, $attrs, $window, fileUpload) {
                ...
                $element.fileupload(angular.extend(
                    ...
                    var uploaded = _.filter($scope.queue, function(file) {
                       return  file.status
                    });
                    if (e.type === 'fileuploadalways' && uploaded.length == $scope.queue.length) {
                        if ($scope.$emit('alluploaded', data).defaultPrevented) {
                            e.preventDefault();
                        }
                    }
                }).on('remove', function () {
